...
public class FullRowCumsumTest extends AutomatedTestBase
{
	...
	@Test
	public void testCumsumRowVectorDenseSP() { runColAggregateOperationTest(InputType.ROW_VECTOR, false, ExecType.SPARK); }
	
	@Test
	public void testCumsumRowVectorDenseNoRewritesSP() { runColAggregateOperationTest(InputType.ROW_VECTOR, false, ExecType.SPARK, false); }
